            ...
            <div class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-30 lg:text-center">
                <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
                    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
                        <span class="block text-red-700 xl:inline"> micro:bit Tutorials </span>
                    </h1>
                    <h2 class=" pt-8 text-2xl tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-4xl lg:text-3xl xl:text-4xl">
                        <span class="block xl:inline" style="color:#76B82A"> Coming Soon... Content under construction..... </span>
                    </h2>
                 </div>
            </div>
            <div class="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full">
                <img class="absolute inset-0 w-full h-full object-cover" src="/images/microbit.png  " alt="Image of RaspiKidd programming">
            </div>
        </main>
        <!--footer -->
