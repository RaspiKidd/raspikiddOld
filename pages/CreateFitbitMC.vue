        ...
        <div class="relative py-16 bg-white overflow-hidden">
          ...
          <div class="relative px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
              ...
              <figure>
                <img class="w-full rounded-lg" src="@/static/images/FitBit_MC_01.png" alt="" width="1310" height="873">
              ...
              <figure>
                <img class="w-full rounded-lg" src="@/static/images/FitBit_MC_02.png" alt="" width="500" height="873">
              ...
              <figure>
                <img class="w-full rounded-lg" src="@/static/images/FitBit_MC_03.png" alt="" width="500" height="873">
              ...
              <figure>
                <img class="w-full rounded-lg" src="@/static/images/FitBit_MC_04.png" alt="" width="500" height="500">
              ...
              <figure>
                <img class="w-full rounded-lg" src="@/static/images/FitBit_MC_05.png" alt="" width="500" height="500">
